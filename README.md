...
Opened is a simple Android app that counts how often you unfold your phone and
...
### [Download the latest APK](https://github.com/teegles/Opened/releases/download/v0.2.4-alpha/Opened-v0.2.4-alpha.apk)
...
Opened has no internet, location, or app-usage access. Android requires a
